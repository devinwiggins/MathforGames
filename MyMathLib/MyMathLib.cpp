...
ofstream & operator<<(ofstream & output, Vector2 & n)
{
	output << "<" << setDecLimit(n.m_x, 3u) << ", " << setDecLimit(n.m_y, 3u) << ">\n";
	return output;
}

ofstream & operator<<(ofstream & output, Vector3 & n)
{
	output << "<" << setDecLimit(n.m_x, 3u) << ", " << setDecLimit(n.m_y, 3u) << ", " <<  setDecLimit(n.m_z, 3u) << ">\n";
	return output;
}

ofstream & operator<<(ofstream & output, Vector4 & n)
{
	output << "<" << setDecLimit(n.m_x, 3u) << ", " << setDecLimit(n.m_y, 3u) << ", " << setDecLimit(n.m_z, 3u) << ", " << setDecLimit(n.m_w, 3u) << ">\n";
	return output;
}
