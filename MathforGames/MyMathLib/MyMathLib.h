...
public:
	...
	friend ofstream& operator << (ofstream & output, Vector2 &n); //prints Vector to file
...
public:
	...
	float operator =(float& A); // can assign all coordinates of a vector to a single float
	friend ofstream& operator << (ofstream & output, Vector3 &n); //prints Vector to file
...
public:
	...
	float operator =(float& A); // can assign all coordinates of a vector to a single float
	friend ofstream& operator << (ofstream & output, Vector4 &n); //prints Vector to file
